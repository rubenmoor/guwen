...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hanzi.heisigID'
        db.add_column(u'guwen_hanzi', 'heisigID',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hanzi.heisigID'
        db.delete_column(u'guwen_hanzi', 'heisigID')
    ...
    models = {
        ...
        u'guwen.hanzi': {
            ...
            'heisigID': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
