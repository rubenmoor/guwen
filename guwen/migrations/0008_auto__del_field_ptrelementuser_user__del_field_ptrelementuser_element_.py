...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PtrElementUser.user'
        db.delete_column(u'guwen_ptrelementuser', 'user_id')

        # Deleting field 'PtrElementUser.element'
        db.delete_column(u'guwen_ptrelementuser', 'element_id')

        # Adding field 'PtrElementUser.englishterm'
        db.add_column(u'guwen_ptrelementuser', 'englishterm',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['guwen.EnglishTerm']),
                      keep_default=False)

        # Adding field 'PtrElementUser.hanzi'
        db.add_column(u'guwen_ptrelementuser', 'hanzi',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['guwen.Hanzi']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PtrElementUser.user'
        raise RuntimeError("Cannot reverse this migration. 'PtrElementUser.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PtrElementUser.user'
        db.add_column(u'guwen_ptrelementuser', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guwen.Hanzi']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'PtrElementUser.element'
        raise RuntimeError("Cannot reverse this migration. 'PtrElementUser.element' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PtrElementUser.element'
        db.add_column(u'guwen_ptrelementuser', 'element',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guwen.EnglishTerm']),
                      keep_default=False)

        # Deleting field 'PtrElementUser.englishterm'
        db.delete_column(u'guwen_ptrelementuser', 'englishterm_id')

        # Deleting field 'PtrElementUser.hanzi'
        db.delete_column(u'guwen_ptrelementuser', 'hanzi_id')
    ...
    models = {
        ...
        u'guwen.ptrelementuser': {
            ...
            'englishterm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['guwen.EnglishTerm']"}),
            'hanzi': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['guwen.Hanzi']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
