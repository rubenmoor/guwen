...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hanzi.heisigBook'
        db.alter_column(u'guwen_hanzi', 'heisigBook', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'Hanzi.heisigBook'
        db.alter_column(u'guwen_hanzi', 'heisigBook', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        u'guwen.hanzi': {
            ...
            'heisigBook': ('django.db.models.fields.CharField', [], {'default': "'RSH1'", 'max_length': '16'}),
