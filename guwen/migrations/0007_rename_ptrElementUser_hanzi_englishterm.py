...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('guwen_ptrelementuser', 'user_id', 'hanzi_id')
        db.rename_column('guwen_ptrelementuser', 'element_id', 'englishterm_id')

    def backwards(self, orm):
        db.rename_column('guwen_ptrelementuser', 'hanzi_id', 'user_id')
        db.rename_column('guwen_ptrelementuser', 'englishterm_id', 'element_id')
